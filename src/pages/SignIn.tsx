  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      if (success) {
        ...
        // For demo: redirect admins to admin dashboard
        ...
        >
          ...
          <div className="glass-card p-8 rounded-xl">
            ...
            <div className="mt-8 text-sm border-t pt-4">
              <p className="text-muted-foreground mb-2 text-center font-medium">Demo Accounts</p>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-xs rounded bg-secondary p-2">
                  <p><span className="font-medium">Admin:</span> admin@college.edu</p>
                  <p><span className="font-medium">Password:</span> password</p>
                </div>
              </div>
            </div>
